<template>
  <section
    ...
    "
  >
    <div class="bg-yellow-400" ref="wrapper"></div>
  </section>
  <div class="">
    <router-view />
  </div>
...
export default {
  setup() {
    ...
    onMounted(() => {
      ...
      wrapper.value.className =' wrapper scale-125 absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 grid grid-cols-10 place-items-center'
